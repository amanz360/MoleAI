...
public class MoleUnit{
	...
	public void setBehavior(IBTExecutor behavior)
	{
		this.behaviorExecutor = behavior;
	}
	
	public void tickBehavior()
	{
		this.behaviorExecutor.tick();
	}
	...
	public void smartAttackUnit(Unit target, Game game)
	{
	   ...
	   // System.out.println("Last command: " + currentCommand.toString());
	    ...
	    myTarget = new PositionOrUnit(target);
	...
	public void smartKiteTarget(Unit target, Game game)
	{
		...
		if(kite)
		{
			...
			myTarget = new PositionOrUnit(fleePosition);
